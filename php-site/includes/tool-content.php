<?php
/**
 * Per-category "About the tool" content shown on every tool page.
...
return [
  'text' => [
    ...
    'places' => [
      [
        ...
        'Check readability, headings, keyword placement and content length before publishing.',
      ],
      [
        'Product descriptions',
        'Remove duplicated manufacturer copy and make product pages unique, specific and useful.',
      ],
      [
        'Landing pages',
        'Ensure the opening paragraph, benefits and calls to action are clear and persuasive.',
      ],
      [
        'Academic or business writing',
        'Catch grammar, punctuation, capitalisation and sentence-structure issues early.',
      ],
      [
        'Email newsletters',
        'Improve clarity before copying content into an email platform.',
      ],
      [
        'Client or agency deliverables',
        'Run a quick final quality-control pass before sending work for approval.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Faster editing',
        'text' => 'Get immediate feedback instead of waiting for a manual proofreading pass.',
      ],
      [
        'title' => 'More consistent content',
        'text' => 'Apply the same readability and on-page standards across every page.',
      ],
      [
        'title' => 'Better reader experience',
        'text' => 'Clear sentences, headings and structure reduce bounce risk and improve comprehension.',
      ],
      [
        'title' => 'Private drafts',
        'text' => 'Unpublished text is handled in your browser and is not uploaded for processing.',
      ],
    ],
    'tips' => [
      'Write for the reader first and search engines second.',
      'Short paragraphs, headings and lists make technical text easier to scan.',
      'Keep the primary topic consistent across the title, H1, opening paragraph and URL.',
    ],
    'faqs' => [
      'Do I need to create an account?',
      'Is the text I paste uploaded to a server?',
      'What writing issues does this tool check?',
      'How often should I run a text or SEO content check?',
      'Can I use this tool for blog posts, product pages and essays?',
      'Does the tool replace a professional proofreader or editor?',
    ],
  ],
  'keyword' => [
    ...
    'places' => [
      [
        'Content planning',
        'Build content calendars around questions and topics with clear intent.',
      ],
      [
        'New landing pages',
        'Select a focused phrase before writing titles, headings and body copy.',
      ],
      [
        'E-commerce categories',
        'Use shopper language, attributes and product modifiers in category copy.',
      ],
      [
        'Local service pages',
        'Combine service terms with locations, problem phrases and common questions.',
      ],
      [
        'Competitor research',
        'Compare the topics competitors target and identify less crowded opportunities.',
      ],
      [
        'Website information architecture',
        'Group related keywords into logical pages instead of competing pages.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Clearer targeting',
        'text' => 'Each page can focus on a specific intent instead of covering several topics weakly.',
      ],
      [
        'title' => 'Better long-tail opportunities',
        'text' => 'Specific phrases often have less competition and higher conversion intent.',
      ],
      [
        'title' => 'Stronger content briefs',
        'text' => 'Writers receive the terms, questions and related topics a page should cover.',
      ],
      [
        'title' => 'Less keyword cannibalisation',
        'text' => 'You can assign distinct keywords to pages instead of repeating the same phrase everywhere.',
      ],
    ],
    'tips' => [
      'One well-targeted page usually outperforms a page stuffed with many unrelated terms.',
      'Long-tail phrases often convert better because they express clearer intent.',
      'Avoid using the same keyword on multiple competing pages.',
    ],
    'faqs' => [
      'What is a primary keyword?',
      'What is the difference between short-tail and long-tail keywords?',
      'What keyword density should I use?',
      'Are related keywords important?',
      'How do I choose the best keyword for a page?',
      'Should I optimise one page for several keywords?',
    ],
  ],
  'backlink' => [
    ...
    'places' => [
      [
        'Competitor analysis',
        'Identify the websites that link to competing pages and look for legitimate opportunities.',
      ],
      [
        'Content promotion',
        'Find sites that already cover a related topic and may reference your resource.',
      ],
      [
        'Digital PR',
        'Support outreach with information about domain relevance and linking patterns.',
      ],
      [
        'Technical SEO audits',
        'Check broken internal links, redirects and nofollow attributes.',
      ],
      [
        'Local business SEO',
        'Review citations, directories and links from regional or industry websites.',
      ],
      [
        'Migration recovery',
        'Detect references that may break or lose value during a domain or URL migration.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Improved authority signals',
        'text' => 'Relevant trusted links can help search engines understand your credibility.',
      ],
      [
        'title' => 'More referral traffic',
        'text' => 'Useful links can send visitors directly from other websites.',
      ],
      [
        'title' => 'Better crawl discovery',
        'text' => 'Strong internal and external links help crawlers find important pages.',
      ],
      [
        'title' => 'Risk awareness',
        'text' => 'You can identify nofollow patterns, broken links and profiles that need review.',
      ],
    ],
    'tips' => [
      'A small number of authoritative, relevant links is usually better than many low-quality links.',
      'Nofollow links can still send valuable referral traffic.',
      'Fix broken internal links before building new external links.',
    ],
    'faqs' => [
      'What is a backlink?',
  ...
  'management' => [
    ...
    'places' => [
      [
        ...
        'Confirm tags, canonical URLs, mobile layout and sharing data are present.',
      ],
      [
        'After a redesign',
        'Verify that forms, redirects, scripts, headings and structured data still work.',
      ],
      [
        'Routine website maintenance',
        'Catch accidental noindex rules, missing tags or heavy resources early.',
      ],
      [
        'Developer QA',
        'Provide a quick checklist when reviewing pull requests or staging pages.',
      ],
      [
        'Client reporting',
        'Turn technical findings into a simple status report with actionable items.',
      ],
      [
        'Migration checks',
        'Compare old and new pages for canonical, redirect, header and metadata consistency.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Fewer indexing problems',
        'text' => 'Blocked pages, bad canonicals and missing tags are easier to catch early.',
      ],
      [
        'title' => 'Consistent sharing',
        'text' => 'Open Graph and Twitter data control how pages appear when shared.',
      ],
      [
        'title' => 'Faster launches',
        'text' => 'A repeatable checklist reduces missed steps before release.',
      ],
      [
        'title' => 'Cross-team clarity',
        'text' => 'Marketers and developers see the same technical requirements and status.',
      ],
    ],
    'tips' => [
      'Re-test after deploying changes because caches and proxies can delay updates.',
      'Keep structured data, meta tags and social tags consistent with the page content.',
      'Document changes so regressions are easier to diagnose later.',
    ],
    'faqs' => [
      'Why is website management important for SEO?',
      'How often should I audit my website?',
      'Can these tools detect every issue?',
      'Do browser-based tools access private pages?',
  ...
  'checker' => [
    ...
    'places' => [
      [
        'SEO audits',
        'Prioritise technical and on-page fixes using clear status indicators.',
      ],
      [
        'Client onboarding',
        'Create a baseline report before starting optimisation work.',
      ],
      [
        'Competitor comparison',
        'Compare how competitors structure pages and handle basic SEO requirements.',
      ],
      [
        'Post-launch verification',
        'Confirm that production pages meet the launch checklist.',
      ],
      [
        'Performance triage',
        'Identify heavy scripts, large HTML and unoptimised resources.',
      ],
      [
        'Marketing QA',
        'Check social tags, titles, descriptions and mobile appearance before campaigns.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Fast overview',
        'text' => 'Many important checks are consolidated into one easy-to-read report.',
      ],
      [
        'title' => 'Actionable priorities',
        'text' => 'Errors and warnings show where development or content work should begin.',
      ],
      [
        'title' => 'Repeatable process',
        'text' => 'The same checks can be applied to every important page template.',
      ],
      [
        'title' => 'Better page experience',
        'text' => 'Mobile, speed, security and metadata improvements benefit both users and search engines.',
      ],
    ],
    'tips' => [
      'A high score is useful, but user experience and business goals also matter.',
      'Warnings are opportunities; errors usually have a more direct SEO impact.',
      'Check representative pages rather than relying on the homepage alone.',
    ],
    'faqs' => [
      'How is the website score calculated?',
      'Why might the result differ from Google PageSpeed Insights?',
      'Does a good score guarantee top rankings?',
      'Which issues are most important?',
      'Why can some pages not be fetched?',
  ...
  'domain' => [
    ...
    'places' => [
      [
        'Buying a domain',
        'Check age, expiry, registrar, status and nameservers before purchase.',
      ],
      [
        'Competitive research',
        'Compare authority indicators and registration history across competitors.',
      ],
      [
        'Domain migrations',
        'Confirm registrar, DNSSEC and nameserver details before changing infrastructure.',
      ],
      [
        'Brand protection',
        'Monitor expiry dates and avoid accidental loss of important domains.',
      ],
      [
        'Website acquisition',
        'Review domain history and link signals as part of due diligence.',
      ],
      [
        'Troubleshooting DNS',
        'Identify nameserver and registry details when email or hosting behaves unexpectedly.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Better purchasing decisions',
        'text' => 'Registration, expiry and registrar information reduce avoidable domain risk.',
      ],
      [
        'title' => 'Migration confidence',
        'text' => 'Nameserver and DNSSEC details help prevent email, hosting and certificate issues.',
      ],
      [
        'title' => 'Competitive context',
        'text' => 'Domain metrics provide a rough view of a site’s accumulated trust signals.',
      ],
      [
        'title' => 'Renewal protection',
        'text' => 'Clear expiry information helps prevent accidental domain expiration.',
      ],
    ],
    'tips' => [
      'Domain age is only one small trust signal; content and links matter more.',
      'Check expiry dates to avoid accidental domain loss.',
      'Review DNSSEC, nameservers and registrar details during migrations.',
    ],
    'faqs' => [
      'What is domain age?',
      'Does an older domain automatically rank better?',
      'What is domain authority?',
      'Why might a domain be unavailable in public registries?',
      'How do I check whether a domain is expiring?',
      'Does this tool replace a full WHOIS or DNS service?',
    ],
  ],
  'ip' => [
    ...
    'places' => [
      [
        ...
        'Confirm which network or data centre is serving a website.',
      ],
      [
        'CDN verification',
        'See whether a domain resolves to Cloudflare, Akamai, Fastly or another edge network.',
      ],
      [
        'Proxy or VPN diagnostics',
        'Understand why a website appears in another region or network.',
      ],
      [
        'Migration testing',
        'Verify that DNS changes point to the expected new server.',
      ],
      [
        'Security reviews',
        'Review hosting, ASN and approximate network location during incident response.',
      ],
      [
        'Developer testing',
        'Compare local, staging and production network information from the browser.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'No command line required',
        'text' => 'Get IP and hosting information using a simple web form.',
      ],
      [
        'title' => 'Faster DNS troubleshooting',
        'text' => 'CDN, network and location details help isolate routing problems.',
      ],
      [
        'title' => 'Useful migration checks',
        'text' => 'You can verify whether a domain still points to an old infrastructure address.',
      ],
      [
        'title' => 'Transparent geolocation limits',
        'text' => 'The tool makes it clear that IP location is approximate.',
      ],
    ],
    'tips' => [
      'IP geolocation is approximate and commonly identifies a data centre rather than an end user.',
      'A CDN can serve many locations from different IP addresses.',
      'Never treat an IP lookup as proof of a person’s exact physical address.',
    ],
    'faqs' => [
      'What is an IP address?',
      'What is the difference between IPv4 and IPv6?',
      'Why is the geolocation approximate?',
      'What is a Class C IP block?',
      'Why does my website show a CDN or hosting IP?',
      'Can I find someone’s exact location from an IP address?',
    ],
  ],
  'pdf' => [
    ...
    'places' => [
      [
        ...
        'Merge, split or rotate contracts, forms, invoices and reports.',
      ],
      [
        'Student and academic work',
        'Convert notes or essays to PDF and combine assignment pages.',
      ],
      [
        'Client deliverables',
        'Compress large reports or convert documents before sending them.',
      ],
      [
        'Scanned paperwork',
        'Reorder, rotate or compress image-based PDFs for easier sharing.',
      ],
      [
        'Legal and finance teams',
        'Prepare paginated documents without uploading confidential files.',
      ],
      [
        'Web publishing',
        'Convert text, spreadsheets or presentations into portable downloadable documents.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Private processing',
        'text' => 'Most PDF operations happen on the device, reducing file-sharing risk.',
      ],
      [
        'title' => 'No software install',
        'text' => 'Common document tasks are available directly in the browser.',
      ],
      [
        'title' => 'Smaller files',
        'text' => 'Compression can reduce email and upload limits and speed up downloads.',
      ],
      [
        'title' => 'Flexible output',
        'text' => 'Merge, split, rotate and convert documents to match the required workflow.',
      ],
    ],
    'tips' => [
      'Scanned PDFs are images, so text extraction or search may require OCR.',
      'Lower compression targets reduce file size but can soften images.',
      'Keep an uncompressed backup before making irreversible changes.',
    ],
    'faqs' => [
      'Are my PDF files uploaded to a server?',
      'Why is text missing after conversion?',
      'What is the difference between lossless and target-size compression?',
      'Can I edit a scanned PDF?',
      'Why does my converted document have different line breaks?',
  ...
  'calculatorLegacy' => [
    ...
    'places' => [
      [
        'Sales and pricing',
        'Work out markup, margin, discounts and taxes before you publish a price.',
      ],
      [
        'Marketing budgets',
        'Estimate ad spend, CPM costs, revenue projections and campaign ROI.',
      ],
      [
        'Financial reporting',
        'Calculate EPS, LTV, GST and other figures required for quick business reviews.',
      ],
      [
        'Retail and e-commerce',
        'Check sale prices, discounts and PayPal fees before listing a product.',
      ],
      [
        'Health and fitness',
        'Estimate BMI and track changes alongside weight, height or exercise data.',
      ],
      [
        'Education and research',
        'Run quick statistical checks with confidence intervals, averages and probability.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Instant answers',
        'text' => 'Get the result as fast as you can type the numbers — no spreadsheets required.',
      ],
      [
        'title' => 'Fewer manual mistakes',
        'text' => 'Structured inputs and a single formula reduce the chance of arithmetic errors.',
      ],
      [
        'title' => 'Private by default',
        'text' => 'Numbers stay in your browser; there is no server to trust with business or health data.',
      ],
      [
        'title' => 'Portable across devices',
        'text' => 'Every calculator works on desktop, tablet and phone with no setup or login.',
      ],
    ],
    'tips' => [
      'Double-check that you enter the right number of decimals, especially for finance.',
      'Use the "extract" or "reverse" mode when you already have the final amount.',
      'For marketing projections, remember that averages are estimates, not guarantees.',
      'Save the result as a screenshot if you need to share it in a report or message.',
    ],
    'faqs' => [
      'How do I open the calculator for my use case?',
      'Are the formulas behind these calculators publicly verifiable?',
      'Can I use these calculators in mobile browsers?',
      'Why would I use a browser calculator instead of a spreadsheet?',
  ...
  'converterLegacy' => [
    ...
    'places' => [
      [
        ...
        'Convert lengths, areas and pressure units across countries and specification sheets.',
      ],
      [
        'Manufacturing and supply chain',
        'Translate dimensions, weights and tolerances between imperial and metric workflows.',
      ],
      [
        'International travel and logistics',
        'Switch between time zones, speeds and distances when planning trips or shipments.',
      ],
      [
        'Science and education',
        'Convert laboratory, physics and maths units accurately for reports and classwork.',
      ],
      [
        'Energy and utilities',
        'Check power, voltage and pressure figures in watts, BTU, PSI or kilopascals as needed.',
      ],
      [
        'Fitness and cooking',
        'Move between grams, ounces, pounds and stones when reading or writing nutritional information.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Instant unit switching',
        'text' => 'Compare measurements without retyping or rebuilding formulas manually.',
      ],
      [
        'title' => 'Accurate by design',
        'text' => 'The tool uses standard mathematical conversions so results are consistent every time.',
      ],
      [
        'title' => 'Works anywhere',
        'text' => 'No app install required; open the page on any device with a browser and use it.',
      ],
      [
        'title' => 'Good for quick comparisons',
        'text' => 'Easily see the same value in several related units at once.',
      ],
    ],
    'tips' => [
      'Check the input unit before reading the result, especially when copying numbers from a PDF or spreadsheet.',
      'Temperature conversions are not simple multiplications — use the full Celsius/Fahrenheit/Kelvin formula.',
      'For critical work, confirm the result against an official reference or the published conversion table.',
      'Time zone conversions depend on whether daylight-saving applies in each location.',
    ],
    'faqs' => [
      'What is the difference between imperial and metric units?',
      'How do I convert Celsius to Fahrenheit without a tool?',
      'Are these conversions exact or rounded?',
      'Which converter should I use for shipping weights?',
      'Does the time zone converter account for daylight-saving?',
      'Can I use these converters for business reports?',
    ],
  ],
  'calculator' => [
    ...
    'use' => [
      ...
      'Enter the numbers and select the appropriate calculation mode.',
      'Review the headline result and supporting values.',
      'Use the result as a planning estimate or as a check against your spreadsheet.',
    ],
    'places' => [
      [
        'Pricing and sales',
        'Calculate margin, markup, discounts, GST and sales tax before publishing prices.',
      ],
      [
        'Marketing campaigns',
        'Estimate CPM, customer lifetime value and likely advertising returns.',
      ],
      [
        'Business reporting',
        'Work out EPS, averages, percentages and confidence intervals for reports.',
      ],
      [
        'E-commerce operations',
        'Check sale prices, payment fees and net revenue per transaction.',
      ],
      [
        'Education and research',
        'Use statistical calculators for sample analysis and classroom exercises.',
      ],
      [
        'Personal planning',
        'Estimate BMI, age milestones and other everyday measurements quickly.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Fast decisions',
        'text' => 'Get a useful estimate while you are planning, pricing or reviewing data.',
      ],
      [
        'title' => 'Clear formulas',
        'text' => 'Results are labelled plainly, with the supporting numbers shown next to them.',
      ],
      [
        'title' => 'Private figures',
        'text' => 'Your business and personal numbers remain in the browser session.',
      ],
      [
        'title' => 'Mobile-friendly',
        'text' => 'The same calculators work on your phone without downloading an app.',
      ],
    ],
    'tips' => [
      'Use the correct units and decimal places before trusting a result.',
      'Treat advertising, LTV and revenue projections as estimates rather than guarantees.',
      'For tax and health decisions, confirm the output with official or professional advice.',
      'Keep a copy of important calculations in your business records.',
    ],
    'faqs' => [
      'Are the calculator formulas accurate?',
      'Can I use these calculators on my phone?',
      'Are my numbers stored or uploaded?',
      'Can I use calculator results in a business report?',
      'Why might my result differ from a spreadsheet?',
      'Are tax, finance and BMI results professional advice?',
    ],
  ],
  'converter' => [
    ...
    'use' => [
      'Choose the measurement category you need.',
      'Select the input and output units.',
      'Enter a number and review the converted value.',
      'Check the reference information before using the value in critical work.',
    ],
    'places' => [
      [
        'Engineering and construction',
        'Convert dimensions, pressure, area and power between supplier specifications.',
      ],
      [
        'Manufacturing and logistics',
        'Translate weights, distances and measurements across international standards.',
      ],
      [
        'Travel planning',
        'Compare distances, speeds and local times across countries.',
      ],
      [
        'Science and education',
        'Check unit conversions for homework, lab notes and technical documents.',
      ],
      [
        'Energy and utilities',
        'Convert voltage, power, pressure and related technical measurements.',
      ],
      [
        'Food, fitness and retail',
        'Switch grams, ounces, pounds, kilograms and other consumer-facing units.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Consistent results',
        'text' => 'Standard conversion factors remove repeated manual calculations.',
      ],
      [
        'title' => 'Quick comparisons',
        'text' => 'See a value in familiar units before making a practical decision.',
      ],
      [
        'title' => 'No installation',
        'text' => 'Open the converter on any device with a browser and use it immediately.',
      ],
      [
        'title' => 'Reduced mistakes',
        'text' => 'The selected source and destination units stay visible beside the result.',
      ],
    ],
    'tips' => [
      'Always check the selected source unit before copying the output.',
      'Temperature uses formulas rather than a simple multiplier.',
      'For regulated or safety-critical work, confirm conversions against your official specification.',
      'Time zone results can change with daylight-saving rules.',
    ],
    'faqs' => [
      'Are the conversion factors exact?',
      'What is the difference between metric and imperial units?',
      'Does the time-zone tool handle daylight saving?',
      'Can I use the converter for technical specifications?',
      'Which unit should I use for an international report?',
      'Can these tools convert multiple values at once?',
    ],
  ],
  'image' => [
    ...
    'places' => [
      [
        ...
        'Prepare fast-loading featured images and in-content screenshots.',
      ],
      [
        'E-commerce',
        'Resize product photos consistently and reduce page weight.',
      ],
      [
        'Social sharing',
        'Create correctly sized images for cards, profiles and promotions.',
      ],
      [
        'Website performance audits',
        'Compress images flagged as heavy contributors to LCP or bandwidth.',
      ],
      [
        'Email campaigns',
        'Reduce attachment and hosted-image size for faster loading.',
      ],
      [
        'Design handoffs',
        'Export web-friendly assets without relying on desktop editing software.',
      ],
    ],
    'benefits' => [
      [
        'title' => 'Faster pages',
        'text' => 'Smaller image files reduce load time and mobile data usage.',
      ],
      [
        'title' => 'Better Core Web Vitals',
        'text' => 'Optimised, correctly sized images improve LCP and reduce layout shift.',
      ],
      [
        'title' => 'Consistent visuals',
        'text' => 'Resizing makes thumbnails, heroes and product images more uniform.',
      ],
      [
        'title' => 'Simple workflow',
        'text' => 'Compress and export directly in the browser without an image editor.',
      ],
    ],
    'tips' => [
      'Use WebP or AVIF where supported and keep JPG/PNG fallbacks where necessary.',
      'Set explicit width and height attributes to reduce layout shift.',
      'Compress images before uploading them to the CMS.',
    ],
    'faqs' => [
